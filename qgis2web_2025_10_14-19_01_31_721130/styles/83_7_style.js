var size = 0;
var placement = 'point';
function categories_83_7(feature, value, size, resolution, labelText,
...
var style_83_7 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Lt") !== null) {
        labelText = String(feature.get("Lt"));
    }
    
    var style = categories_83_7(feature, value, size, resolution, labelText,
