...
map.getView().fit([-6335017.005455, -2925278.961938, -6334521.534032, -2924992.548354], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">WEB_MAP (QFieldCloud)</h2>';
        return titleElement;
    })(),
